...
Define middleware-level behavior for filesystem-discovered skills, including discovery, validation, activation, prompt injection, and progressive disclosure.
